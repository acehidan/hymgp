      ...
      <section className="py-16 lg:py-20 bg-light border-y border-light-2">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 xl:px-12 text-center">
          <ScrollReveal>
            ...
            <h2 className="font-heading text-4xl lg:text-[2.5rem] font-bold text-dark leading-tight">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8">
            {[
              ...
              <ScrollReveal key={tag} delay={0.05 * i}>
                <span
                  className="inline-block text-[0.8rem] font-semibold tracking-wider px-7 py-3 border-2 border-light-2 text-slate bg-white hover:bg-green-light hover:text-green-dark hover:border-green transition-all duration-200 cursor-default"
                >
                  {tag}
                </span>
              </ScrollReveal>
