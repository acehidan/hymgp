            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="mb-6 pb-6 border-b border-light-2">
                  ...
                  <a
                    href="mailto:kevinlin@hymgp.com"
            ...
            <div>
              <div className="bg-dark p-8 lg:p-10 text-white">
                ...
                <p className="text-[0.83rem] text-white/55 leading-[1.8] mb-8">
                  For direct and timely communication particularly for
                  investment discussions, technology partnerships, and
                  international business enquiries our team is available on
                  WeChat.
                </p>
                ...
                <div className="mt-6 p-4 bg-yellow/[0.08] border-l-[3px] border-yellow">
                  <p className="text-[0.75rem] text-white/50 leading-relaxed">
                    <strong className="text-yellow font-medium">Note:</strong>{" "}
                    Replace the QR placeholder above with your official WeChat
                    QR code image.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-px p-6 bg-green-light border-l-[3px] border-green">
                <p className="text-[0.82rem] text-slate leading-[1.75]">
                  ...
                  . For time-sensitive matters including investment discussions
            ...
            {sectorContacts.map((item, i) => (
              <ScrollReveal key={item.label} delay={i * 0.1}>
                ...
                >
                  ...
                  <p className="text-[0.8rem] text-slate-2 leading-[1.7]">
                    {item.text}
                  </p>
                </div>
              </ScrollReveal>
