        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-8 xl:px-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2.5 mt-8">
            {commitments.map((tag) => (
              <span
                key={tag}
                className="text-[0.65rem] font-medium tracking-wider px-5 py-2 border border-light-2 text-slate hover:bg-green-light hover:text-green-dark hover:border-green transition-all duration-200"
              >
                {tag}
              </span>
            ))}
